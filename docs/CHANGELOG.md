...
- Clear browser data is unavailable, with a reason, while a Popout is still opening or returning, and a Popout launch overtaken by Clear browser data or closing PiPlay rolls back instead of opening.
