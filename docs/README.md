...
**Status:** Draft 0.10 / Phase 2 landed; Phase 3 resize implemented and compact-player sweep ready | **Platform:** Windows | **Stack:** WPF on .NET 10 | Microsoft Edge WebView2 (Evergreen)
