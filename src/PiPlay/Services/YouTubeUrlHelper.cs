...
/// <summary>
/// Parses supported YouTube URLs and builds watch/embed target URLs.
...
public static class YouTubeUrlHelper
{
    ...
    /// <summary>Build a normal-mode watch URL.</summary>
    ...
    /// <summary>
    /// Build the local compact-shell URL: the shell base (a WebView2 virtual host such
    ...
    /// <summary>
    /// Build a direct compact embed URL. Reserved for a future direct-embed fallback
    ...
    public static int? ParseTime(string? value)
    {
        ...
        // unchecked arithmetic did both, surfacing the generic crash dialog instead of failing gracefully.
    ...
    /// link) — the only surface Auto pops out. Excludes <c>/shorts/</c>, <c>/embed/</c>,
    ...
    /// popouts carry them like any playlist (PopoutTargetResolver). Only the compact URL
    ...
    private static void ApplyList(YouTubeTarget target, string list)
    {
        ...
        // query value carrying '&'/'=' must never round-trip into them; degrade instead of mangling.
