...
public sealed class ThemeSettings
{
    ...
    /// primary action; 100 gives the toolbar glyphs the full accent and the title bar its strongest
    /// wash. A user preference, NOT a preset trait — a preset switch must not reset it. Missing from an
    /// older settings.json → the property initializer keeps the default, so no schema bump is needed.
    /// </summary>
