...
public static class ThemePreferenceResolver
{
    ...
    // Behavior values resolve preset default → explicit override → normalized (end-pass review
    // F2): a theme block with null overrides gets the PRESET's behavior, so a hand-edited
